class HomePage {
  ...
  whatsNearYou() {
    return cy.get('.section-7_btn1__YvVpM');
  }

  postYourGoods() {
    return cy.get('.section-7_btn2__2lv_r');
  }

  footerBlog() {
    return cy.get(':nth-child(1) > .Footer_listCon__29kxp > :nth-child(3) > a');
  }

  getTheApp(){
    return cy.get(':nth-child(1) > .Footer_listCon__29kxp > :nth-child(2) > a');
  }
  ...
  footerPrivacyPolicy(){
    return cy.get(':nth-child(3) > .Footer_listCon__29kxp > :nth-child(3) > a');
  }
